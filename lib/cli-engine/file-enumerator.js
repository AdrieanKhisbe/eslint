...
/**
 * @typedef FileSelector
 * @param {string} filePath the path to test
 * @returns {boolean} whether file should be consider
 */
...
class FileEnumerator {
    ...
    *iterateFiles(patternOrPatterns) {
    ...
    _iterateFilesWithGlob(pattern, dotfiles) {
        ...
        /**
         * Selector checking wheter filePath should be considered
         * @param {string} filePath path to test
         * @returns {FileSelector} function to tell whether filePath should be considered or not
         */
        function selector(filePath) {
            return micromatch(pattern, filePath, micromatchOpts);
        }
     ...
     * @param {FileSelector} [options.selector] The matcher to choose files
     * @returns {IterableIterator<FileEntry>} The found files.
     * @private
     */
